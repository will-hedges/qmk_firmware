...
#define HL_UP LSFT(KC_UP)
#define HL_DN LSFT(KC_DOWN)
#define CYCLEFT LCTL(KC_PGUP)
#define CYCRGHT LCTL(KC_PGDN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT_83_ansi(
        ...
        _______, _______, _______, _______, RESET,   _______, _______, _______, HL_UP,   _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, CYCLEFT, HL_DN,   CYCRGHT, _______, _______,          _______, _______,
